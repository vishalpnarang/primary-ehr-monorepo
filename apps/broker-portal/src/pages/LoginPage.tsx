...
const LoginPage = () => {
  ...
  const [email, setEmail] = useState('rcastellano@apexbenefitsgroup.com');
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-violet-950 to-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-violet-300 text-sm mt-1">Broker Portal</p>
        </div>

        {/* Card */}
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-1">Welcome back</h2>
          <p className="text-sm text-gray-500 mb-6">Sign in to manage employer accounts and commissions.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-violet-600 hover:bg-violet-700 disabled:bg-violet-400 text-white font-semibold rounded-lg text-sm transition-colors flex items-center justify-center gap-2"
            >
          ...
          <div className="mt-6 p-3 bg-violet-50 border border-violet-100 rounded-lg">
            <p className="text-xs text-violet-700 font-medium">Demo credentials</p>
            <p className="text-xs text-violet-600">rcastellano@apexbenefitsgroup.com / demo1234</p>
          </div>
        </div>
