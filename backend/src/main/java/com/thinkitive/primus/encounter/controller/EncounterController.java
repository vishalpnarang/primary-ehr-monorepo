...
public class EncounterController extends BaseController {
    ...
    @GetMapping("/{uuid}")
    public ResponseEntity<ApiResponse> getEncounter(@PathVariable UUID uuid) {
    ...
    public ResponseEntity<ApiResponse> signEncounter(@PathVariable UUID uuid) {
    ...
    public ResponseEntity<ApiResponse> getEncountersByPatient(@PathVariable UUID patientUuid) {
